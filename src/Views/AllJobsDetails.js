/******************************************************************************************************************\
 *File:    AllJobsDetails.js                                                                                       *
 *Author:  Christopher Perault                                                                                     *
 *Project: Roofmasters CMS (Customer Management System)                                                            *
 *Date:    December 10th, 2019                                                                                     *
 *Purpose: This component represents the view into which a selected job is expanded for details/actions for admins *
\******************************************************************************************************************/
...
const AllJobsDetails = ({ panel }) => {
  ...
  return (
    <div className="all_job_details_expanded_container">
      <div className="all_job_details_expanded_body">
